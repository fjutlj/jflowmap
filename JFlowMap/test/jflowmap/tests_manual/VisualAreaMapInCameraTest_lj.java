 ...
 */
public class VisualAreaMapInCameraTest_lj extends PFrame {
  ...
  public VisualAreaMapInCameraTest_lj() throws IOException {
    setSize(800, 600);
...
//    double scale = Math.min(camera.getWidth() / mapFullBounds.width / 3, camera.getHeight() / mapFullBounds.height);
  ...
  public static void main(String[] args) {
    ...
    try {
      new VisualAreaMapInCameraTest_lj().setVisible(true);
    } catch (IOException e) {
      e.printStackTrace();
    }
